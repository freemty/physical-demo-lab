...
parser.add_argument('--gpu', type=int, default=2, help='Physical renderer GPU index, matched against nvidia-smi at startup')
...
look = Gf.Matrix4d().SetLookAt(Gf.Vec3d(1.95, -2.10, 2.25), Gf.Vec3d(0.12, -0.02, 0.82), Gf.Vec3d(0, 0, 1))
