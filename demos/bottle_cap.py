...
try:
    ...
    scene_api.CreateSolverTypeAttr('PGS')
    scene_api.CreateMinPositionIterationCountAttr(64)
    scene_api.CreateMaxPositionIterationCountAttr(64)
    scene_api.CreateMinVelocityIterationCountAttr(4)
    scene_api.CreateMaxVelocityIterationCountAttr(4)
    scene_api.CreateEnableExternalForcesEveryIterationAttr(False)
    ...
    hand.set_solver_iteration_counts(position_counts=64, velocity_counts=4)
    ...
    run.start({'asset': asset, 'scope': 'contact-driven Allegro cap; equivalent passive spring helix, fixed bottle',
               ...
               'video_fps': 120, 'solver': {'type': 'PGS', 'position_iterations': 64, 'velocity_iterations': 4,
