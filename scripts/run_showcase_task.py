"""Isolated restaurant-showcase runner; original run_task.py stays unchanged."""
import argparse
import json
import os
import subprocess
...
def main():
    ...
    command = [str(runtime/'venv/bin/python'), str(root/'demos/restaurant_showcase.py'), '--output', str(args.output), *remaining]
